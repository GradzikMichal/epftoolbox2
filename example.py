...
if __name__ == "__main__":
    ...
    pipeline.add_model(OLSModel(['load','load-1','load-7'], dummies, name="AR", target='load', trainingWindow=364, saveToFile="ar.json"))
    pipeline.add_model(LassoModel(['load','load-1','load-7','temperature_2m_d+1','cloud_cover_d+1','precipitation_d+1'], dummies, name="ARX", target='load', trainingWindow=364, saveToFile="arx.json"))
